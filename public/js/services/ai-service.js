...
class AIService {
    ...
    prepareRequestData(question, options) {
        ...
        if (options.subject)
            baseData.subject = options.subject;
        if (options.difficulty)
            baseData.difficulty = options.difficulty;
        if (options.helpType)
            baseData.helpType = options.helpType;
        if (options.essayType)
            baseData.essayType = options.essayType;
        if (options.citationStyle)
            baseData.citationStyle = options.citationStyle;
        if (options.minReferences)
            baseData.minReferences = options.minReferences;
    ...
    createSyllabusInstructions(syllabus) {
        if (!syllabus)
            return "";
