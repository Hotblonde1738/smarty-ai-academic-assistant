...
class SyllabusService {
    ...
    async saveToDatabase(syllabus) {
        try {
            ...
            console.warn("⚠️ Database upload failed, using local storage only:", error);
    ...
    loadSyllabi() {
        try {
            ...
            console.log(`📚 Loaded ${this.uploadedSyllabi.length} syllabi from localStorage`);
    ...
    async init() {
        ...
        console.log("✅ Syllabus service initialized with", this.uploadedSyllabi.length, "syllabi");
    ...
    async refreshSyllabi() {
        ...
        console.log(`✅ Refreshed syllabi: ${this.uploadedSyllabi.length} total (was ${currentCount})`);
        return this.uploadedSyllabi;
    }
